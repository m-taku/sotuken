...
PS_BlurInput VSXBlur(VSInput In)
{
	...
	float len = 1.0f;
	float2 tex = In.uv;
	Out.tex0 = tex + float2(-len / texSize.x, 0.0f);
	len += dist;
	Out.tex1 = tex + float2(-len / texSize.x, 0.0f);
	len += dist;
	Out.tex2 = tex + float2(-len / texSize.x, 0.0f);
	len += dist;
	Out.tex3 = tex + float2(-len / texSize.x, 0.0f);
	len += dist;
	Out.tex4 = tex + float2(-len / texSize.x, 0.0f);
	len += dist;
	Out.tex5 = tex + float2(-len / texSize.x, 0.0f);
	len += dist;
	Out.tex6 = tex + float2(-len / texSize.x, 0.0f);
	len += dist;
	Out.tex7 = tex + float2(-len / texSize.x, 0.0f);
	return Out;
}
...
PS_BlurInput VSYBlur(VSInput In)
{
	...
	float len = 1.0f;
	float2 tex = In.uv;
	Out.tex0 = tex + float2(0.0f, -len / texSize.y);
	len += dist;
	Out.tex1 = tex + float2(0.0f, -len / texSize.y);
	len += dist;
	Out.tex2 = tex + float2(0.0f, -len / texSize.y);
	len += dist;
	Out.tex3 = tex + float2(0.0f, -len / texSize.y);
	len += dist;
	Out.tex4 = tex + float2(0.0f, -len / texSize.y);
	len += dist;
	Out.tex5 = tex + float2(0.0f, -len / texSize.y);
	len += dist;
	Out.tex6 = tex + float2(0.0f, -len / texSize.y);
	len += dist;
	Out.tex7 = tex + float2(0.0f, -len / texSize.y);
	return Out;
}
